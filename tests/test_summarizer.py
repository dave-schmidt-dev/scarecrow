...
def test_create_backend_rejects_nemotron_mlx() -> None:
    """_create_backend('mlx', model='nemotron') raises ValueError."""
    with pytest.raises(ValueError, match=r"[Nn]emotron"):
        _create_backend("mlx", model="nemotron")
