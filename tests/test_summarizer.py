...
def test_summarize_session_success(tmp_path: Path) -> None:
    ...
    gguf_dir = tmp_path / "models--unsloth--gemma-3-27b-it-GGUF"
    ...
    assert "gemma-3-27b-it" in content
...
def test_model_name_from_gguf_extracts_repo() -> None:
    path = Path("/cache/models--unsloth--gemma-3-27b-it-GGUF/snapshots/abc/model.gguf")
    assert _model_name_from_gguf(path) == "gemma-3-27b-it"
